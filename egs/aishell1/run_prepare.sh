...
echo "audio path: ${data}/wav"
echo "text path: ${data}/transcript"
...
if [ $stage -le 2 ] && [ $end_stage -ge 2 ]; then
  ...
  # compute global CMVN
  compute-cmvn-stats scp:data/${train_set}/feats.scp data/fbank/cmvn_t.ark || exit 1;
