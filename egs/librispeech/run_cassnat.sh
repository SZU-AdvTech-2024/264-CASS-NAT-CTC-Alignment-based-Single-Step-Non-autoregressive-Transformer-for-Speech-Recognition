...
stage=1
end_stage=1
lm_model=exp2/libri_tfunilm16x512_4card_cosineanneal_ep20_maxlen120/averaged.mdl

asr_exp=exp2/cassnat_noam15k_initart_interctc05_ly6_interce01_ly6_a4000_ptlr4e-4_uptlr1e-3/
...
if [ $stage -le 1 ] && [ $end_stage -ge 1 ]; then
  ...
  CUDA_VISIBLE_DEVICES="1,3" train_asr.py \
    --task "cassnat" \
    --exp_dir $asr_exp \
...
if [ $stage -le 2 ] && [ $end_stage -ge 2 ]; then
  last_epoch=42  # need to be modified
